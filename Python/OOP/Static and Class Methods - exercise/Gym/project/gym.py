...
class Gym:
    ...
    def subscription_info(self, subscription_id: int) -> str:
        ...
        exercise_plan = next(filter(lambda e: e.id == subscription.exercise_id, self.plans))
        equipment = next(filter(lambda e: e.id == exercise_plan.equipment_id, self.equipment))
